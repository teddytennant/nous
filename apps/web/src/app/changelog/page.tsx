...
const CATEGORY_CONFIG: Record<ChangeCategory, { label: string; icon: typeof Sparkles; color: string }> = {
  feature: { label: "Feature", icon: Sparkles, color: "text-[#B23A3A]" },
            ...
            <div className="flex items-start gap-4 sm:gap-6 mb-8">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex flex-wrap items-center gap-3 mb-2">
                  ...
                  {release.latest && (
                    <span className="px-2 py-0.5 text-[10px] font-mono uppercase tracking-wider text-[#B23A3A] border border-[#B23A3A]/30 rounded-sm bg-[#B23A3A]/5">
                      Latest
                    </span>
                  )}
                  <a
                ...
                <div className="flex flex-wrap gap-3 mt-6 pt-6 border-t border-white/[0.04]">
                  ...
                  <Link
                    href="/download"
                    className="inline-flex items-center gap-1.5 text-xs text-[#B23A3A]/70 hover:text-[#B23A3A] transition-colors duration-200 font-light"
                  >
      ...
      <main className="max-w-4xl mx-auto px-6 py-16 sm:py-24">
        ...
        <header className="mb-16">
          <div className="flex flex-wrap items-center gap-3 mb-6">
            <span className="px-2.5 py-1 text-[10px] font-mono uppercase tracking-wider text-[#B23A3A] border border-[#B23A3A]/20 rounded-sm bg-[#B23A3A]/5">
              v{latestVersion}
            </span>
        ...
        {filteredReleases.length > 0 ? (
          ...
          <div className="text-center py-24">
            ...
            <button
              ...
              className="mt-4 text-xs text-[#B23A3A] hover:text-[#B23A3A]/80 transition-colors duration-200 font-light"
            >
              Clear filter
            </button>
          </div>
        ...
        <div className="mt-24 pt-12 border-t border-white/[0.04] text-center">
          ...
          <div className="flex justify-center gap-4">
            ...
            <Link
              href="/download"
              className="inline-flex items-center gap-2 px-5 py-2.5 text-xs font-medium bg-[#B23A3A] hover:bg-[#7A2A2A] active:bg-[#591F1F] text-black rounded-sm transition-colors duration-200"
            >
