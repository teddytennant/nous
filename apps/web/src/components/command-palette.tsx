...
const commands: CommandItem[] = [
  ...
  // Quick Actions
  {
    id: "new-post",
    label: "New Post",
    description: "Write a new post on the social feed",
    icon: Plus,
    href: "/social",
    section: "Quick Actions",
    keywords: ["create", "write", "publish", "tweet"],
  },
  {
    id: "new-message",
    label: "New Message",
  ...
  },
  {
    ...
    href: "/ai",
    section: "Quick Actions",
    keywords: ["assistant", "model", "bot"],
  },
  {
    id: "download-app",
    label: "Download App",
    description: "Get Nous for your platform",
    icon: Download,
    href: "/download",
    section: "Quick Actions",
    keywords: ["install", "desktop", "mobile", "native"],
  },
];
